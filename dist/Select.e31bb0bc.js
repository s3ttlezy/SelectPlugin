...
var getTemplate = function getTemplate() {
  ...
  var placeholder = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'Select something';
  ...
  var items = data.map(function (item) {
    ...
    return "<li class=\"select__item ".concat(cls, "\" data-type=\"item\" data-id=\"").concat(item.id, "\" data-value=\"").concat(item.value, "\">").concat(item.value, "</li>");
  });
...
var Select = /*#__PURE__*/function () {
  ...
  _createClass(Select, [{
    ...
    key: "select",
    value: function select(id, value) {
      this.selectedId = id;
...
window.s = select;
},{"./select/select":"select/select.js","./select/styles.scss":"select/styles.scss"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
